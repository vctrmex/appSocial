...
//  Messenger
//
//  Created by victor manzanero on 08/05/21.
...
class EditProfileViewController: UIViewController,UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.emoji.delegate = self
        self.yearOld.delegate = self
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        switch seleccion {
        case 1:
            emoji.text = bandera[row]
            break;
        case 2:
            yearOld.text = bandera [row]
            break;
        case 3:
            country.text = bandera [row]
            break;
        default:
            print("default")
        }
    ...
    @IBAction func start(_ sender: Any) {
        ...
        seleccion = 1
        self.bandera = allEmojis
        self.emojiPicker.reloadAllComponents()
        self.emojiPicker.isHidden = false
        emoji.resignFirstResponder() // dismiss keyboard
    ...
    @IBAction func startOld(_ sender: Any) {
        
        seleccion = 2
        self.bandera = pickerData
        self.emojiPicker.reloadAllComponents()
        self.emojiPicker.isHidden = false
        self.yearOld.resignFirstResponder()
        
    }
    
    
    @IBAction func endOld(_ sender: Any) {
        
        //self.emojiPicker.isHidden = true
        
    }
    
    @IBAction func endCountry(_ sender: Any) {
        
        //self.emojiPicker.isHidden = true
        
    }
    
    @IBAction func startCountry(_ sender: Any) {
        
        seleccion = 3
        self.bandera = countryData
        self.emojiPicker.reloadAllComponents()
        self.emojiPicker.isHidden = false
